    ...
    <div class="accordion-item card ${this.name.replace(/[^a-zA-Z0-9]/g,"")}-out">
            <h3 class="accordion-header fs-tiny">
              <button type="button" class="accordion-button collapsed noti-card" data-bs-toggle="collapse" data-bs-target="#${this.name.replace(/[^a-zA-Z0-9]/g,"")}" aria-expanded="false">
                <strong><a href="${t}">${a}</a> Total: <span class="total${this.name.replace(/[^a-zA-Z0-9]/g,"")}">0</span>    </strong>
        ...
        <input index="${r}" value="${a}" class="mx-2 my-1" type="checkbox" id="${this.name.replace(/[^a-zA-Z0-9]/g,"")+e.replace(/[^a-zA-Z0-9]/g,"")}" checked>
        <label for="${this.name.replace(/[^a-zA-Z0-9]/g,"")+e.replace(/[^a-zA-Z0-9]/g,"")}">${e}</label>
          ...
          <input index="${r}" value="${a}" class="mx-2 my-1" type="checkbox" id="${this.name.replace(/[^a-zA-Z0-9]/g,"")+e.replace(/[^a-zA-Z0-9]/g,"")}">
          <label for="${this.name.replace(/[^a-zA-Z0-9]/g,"")+e.replace(/[^a-zA-Z0-9]/g,"")}">${e}</label>
        ...
        <input index="${a}" value="${e}" class="mx-2 my-1" type="checkbox" id="${this.name.replace(/[^a-zA-Z0-9]/g,"")+t.replace(/[^a-zA-Z0-9]/g,"")}" checked>
        <label for="${this.name.replace(/[^a-zA-Z0-9]/g,"")+t.replace(/[^a-zA-Z0-9]/g,"")}">${t}</label>
